...
const Bookinglist = () => {
  ...
  const handleBooking = () => {
    if (selectedServices.length && selectedBarbers.length) {
      ...
      const data: string | null = localStorage.getItem("serviceId")
            ...
            {loadingBarbers ? (
              ...
              barbers.map((barber: Barber) => {
                ...
                return (
                  <div
                    key={barber._id}
                    className={`relative w-[180px] flex-shrink-0 p-4 rounded-2xl shadow-md ${isSelected ? "border-blue-500" : "border-[#757442]/40"
